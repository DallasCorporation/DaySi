...
const Access = () => {
  return (<View style={{ alignItems: 'center', backgroundColor: "#FFFCF3", flex: 1 }}>
    ...
    <Image source={logo} style={{ width: 190, height: 190, marginTop: 200, marginBottom: 20 }}></Image>

    <Text style={{ fontSize: 33, color: 'black', fontWeight: 'bold' }}>Benvenuto!</Text>
    <Text style={{ fontSize: 20, color: 'black', marginBottom: 90 }}>Slogan della StarUp</Text>
    {/*DAB741*/}
    ...
    <Text style={{ fontSize: 18, color: 'black' }}>Non sei ancora registrato?Clicca qui!</Text>
